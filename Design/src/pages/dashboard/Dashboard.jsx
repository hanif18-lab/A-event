...
const Dashboard = () => {
  ...
  const EventCard = ({ event }) => {
    ...
    return (
      <div className='bg-Purp rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 overflow-hidden flex flex-col'>
        <div className='p-6 flex flex-col flex-grow'>
          ...
          <div className='mt-6 flex gap-3'>
            <a
              ...
              className='flex-1 px-4 py-2 text-sm rounded-lg text-black bg-white text-center'
            >
              View Bookings
            </a>
            <button
        ...
        return (
          <div>
            ...
            {filteredEvents.length === 0 && (
              <div className='text-center py-16 bg-Purp rounded-xl shadow-sm'>
  ...
  return (
    <div className='min-h-screen bg-white'>
      {/* Mobile Navbar */}
      <div className='md:hidden bg-Purp px-4 py-4'>
        <div className='flex justify-between items-center'>
        <h1 className='text-xl font-bold text-black flex items-center'><FaAccusoft className="text-white"/>-Event</h1>  
          <button
      ...
      {/* Mobile Menu */}
      {isMobileMenuOpen && (
        <div className='md:hidden bg-Purp'>
      ...
      <div className='flex'>
        {/* Desktop Sidebar */}
        <div className='hidden md:block w-64 bg-Purp min-h-screen'>
          <div className='p-6'>
