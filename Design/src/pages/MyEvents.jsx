          ...
          {filteredEvents.length === 0 ? (
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6'>
              {filteredEvents.map((event) => (
                <div
                  key={event._id}
                  className='bg-Purp rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 overflow-hidden flex flex-col'
                >
                  <div className='p-6 flex flex-col flex-grow'>
                    <div className='flex flex-col gap-2'>
                      <div className='flex items-center justify-between'>
                        ...
                        <span className='inline-flex items-center px-2.5 py-0.5 bg-black text-white text-xs font-medium rounded-full'>
                          {event.category}
                        </span>
                      </div>
                    ...
                    <button
                      ...
                      className='mt-6 w-full bg-red-600 px-4 py-2 text-sm text-white border border-red-400/50 rounded-lg hover:bg-red-400/10 transition-colors'
                    >
                      Cancel Reservation
                    </button>
                  </div>
